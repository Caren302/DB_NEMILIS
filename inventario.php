...
"></i></div>
	...
	<section class="full-width pageContent">
		<section class="full-width header-well">			
			<br/>
			<h3 class="text-center tittles">Consulta y administracion de medicamentos de la institución.</h3>	
		</section>
    <div class="full-width panel-content">
            ...
            <?php
                ...
                $sql= "SELECT id,nombre,presentacion,categoria,lote,sector,fecha,estado,cantidad FROM medicamentos WHERE nombre LIKE '$buscar' '%' order by id asc";
                ...
                while ($mostrar = mysqli_fetch_row($rta))
                {
                    ...
                    <tr>
						...
						<td>
							<a href="editarmedicamento.php? 
							id=<?php echo $mostrar['0'] ?> &
							nombre=<?php echo $mostrar['1'] ?> &
							presentacion=<?php echo $mostrar['2'] ?> &
							categoria=<?php echo $mostrar['3'] ?> &
							lote=<?php echo $mostrar['4'] ?> &
							sector=<?php echo $mostrar['5'] ?> &
							fecha=<?php echo $mostrar['6'] ?> &
							estado=<?php echo $mostrar['7'] ?> &
							cantidad=<?php echo $mostrar['8'] ?> 
							">editar</a>
							<a href="eliminarmed.php? 
							id=<?php echo $mostrar['0'] ?>">eliminar</a>
						</td>
					</tr>
                    <?php 
                } 
				...
				<?php
					...
					$sql = "SELECT COUNT(*) total FROM medicamentos";
