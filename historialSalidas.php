...
"></i></div>
	...
	<section class="full-width navLateral">
		...
		<div class="full-width navLateral-body">
			<div class="full-width navLateral-body-logo text-center tittles">
				<i class="zmdi zmdi-close btn-menu"></i> Salidas
			</div>
			...
			<nav class="full-width">
				<ul class="full-width list-unstyle menu-principal">
					...
					<li class="full-width">
						...
						<a href="historialsalidas" class="full-width">
							<div class="navLateral-body-cl">
	...
	<section class="full-width pageContent">
		<section class="full-width header-well">
			 <br/>
				<pre> 
					&nbsp; <h4 class="text-center tittles">El sistema permite de historial de salida de Medicamento de inventario de la institución <br/>Funcion solo para administradores.</h4>	
				</pre>
		</section>
		<form  action="buscar.php" method="post">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
							<i class="zmdi zmdi-search"></i>
							<input type="text" name="buscarsalidas.php"  style="WIDTH: 780px; "size=32 name=text1> &nbsp;       
