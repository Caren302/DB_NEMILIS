			...
			<nav class="full-width">
				<ul class="full-width list-unstyle menu-principal">
					...
					<li class="full-width">
						...
						<a href="historialSalidas.php" class="full-width">
							<div class="navLateral-body-cl">
						...
						<div class="full-width panel mdl-shadow--2dp">
							...
							<div class="full-width panel-content">
								<form action="admin.php" method="post">
									<h5 class="text-condensedLight">Datos de Usuarios</h5>
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<label class="mdl-textfield__label" for="emailClient">Usuario</label>
										<span class="mdl-textfield__error">Usuario obligatorio</span>
									</div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="password" id="password" name="password" required>
										<label class="mdl-textfield__label" for="password">Password</label>
										<span class="mdl-textfield__error">Password obligatorio</span>
									</div>
									<p class="text-center">
